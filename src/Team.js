  ...
  render() {
    return (
      <div className="Team Section">
        ...
        <p>
          Michael Franklin holds a BS degree in biological sciences from Birmingham Southern University.  He was a member of both Biological and Pre-Health Honor Societies. He served as a student assistant in both Cellular and Molecular Biology and Microbiology Departments.  We were happy to have Michael join EMLabs, Inc. team in 2011, where he continues to excel in his development of electron microscopy technical skills and knowledge in ultrastructural pathology.  Michael is a member of the Southeastern Microscopy Society.
        </p>
      </div>
    );
  }
